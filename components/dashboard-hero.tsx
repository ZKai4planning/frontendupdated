...
export function DashboardHero() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="relative w-full max-w-4xl h-100 flex items-center justify-center mb-20">
        <div
          className="absolute w-150 h-100 border-2 border-dashed border-[#135bec]/30 rounded-xl bg-[#135bec]/5 flex items-center justify-center"
          style={{
        ...
        <div className="relative z-30 group">
          ...
          <button className="relative flex min-w-60 cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-xl h-14 px-8 bg-[#135bec] text-white text-lg font-bold shadow-2xl hover:bg-[#135bec]/90 hover:scale-105 transition-all duration-300">
