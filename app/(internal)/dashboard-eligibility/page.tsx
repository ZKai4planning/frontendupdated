          ...
          <div className="col-span-4 space-y-6">
            <div className="rounded-2xl bg-blue-600 p-5 text-white shadow-lg">
              ...
              <p className="text-sm opacity-90 mb-4">
                Hi Zafer Khan, before we prepare your planning application, we
                conduct an Eligibility Check to confirm whether your project
                requires planning permission or qualifies under permitted
                development rights.
              </p>

              {/* HOW IT WORKS */}
              <div className="space-y-3 text-sm opacity-95 mb-5">
                <div className="flex items-start gap-2">
                  <span className="font-semibold">1.</span>
                  <p>
                    We review your property details, location constraints and
                    project scope.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Our system analyses local planning policies and national
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Your assigned consultant validates the findings and advises
